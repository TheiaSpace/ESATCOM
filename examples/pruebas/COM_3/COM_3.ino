...
void loop()
{
  ...
  {    
    ...
    packet.writeByte('E');
    packet.writeByte('T');
    packet.print(ProcessorVoltage.read(), 2);
    packet.println("Pues sepa Vuestra Merced, ante todas cosas, que a mí llaman Lázaro de Tormes, hijo de Tomé González y de Antona Pérez, naturales de Tejares, aldea de Salamanca.");
