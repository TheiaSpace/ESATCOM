/*
 * Copyright (C) 2017, 2018, 2025 Theia Space, Universidad Politécnica de Madrid
 *
...
ESAT_Timestamp ESAT_COMExternalRealTimeClockClass::read()
{
...
void ESAT_COMExternalRealTimeClockClass::write(ESAT_Timestamp timestamp)
{
  // The on-board real-time clock stores the time in seven consecutive
  // registers starting at TIME_REGISTER in the following order:
  // - seconds (from 0 to 59);
...
ESAT_COMExternalRealTimeClockClass ESAT_COMExternalRealTimeClock;
