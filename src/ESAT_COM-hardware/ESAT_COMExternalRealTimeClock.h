...
#ifndef ESAT_COMExternalRealTimeClock_h
#define ESAT_COMExternalRealTimeClock_h
...
extern ESAT_COMExternalRealTimeClockClass ESAT_COMExternalRealTimeClock;

#endif /* ESAT_COMExternalRealTimeClock_h */
