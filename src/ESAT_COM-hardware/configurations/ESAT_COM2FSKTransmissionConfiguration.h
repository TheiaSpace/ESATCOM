 ...
 */
#ifndef ESAT_COM2FSKTransmissionConfiguration_h
#define ESAT_COM2FSKTransmissionConfiguration_h
...
// the transmission transceiver in 2FSK mode.
class ESAT_COM2FSKTransmissionConfigurationClass: public ESAT_COMTransceiverConfigurationClass
{
  public:
