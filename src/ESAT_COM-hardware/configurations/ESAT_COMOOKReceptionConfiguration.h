 ...
 */
#ifndef ESAT_COMOOKReceptionConfiguration_h
#define ESAT_COMOOKReceptionConfiguration_h
...
// the reception transceiver in OOK mode.
class ESAT_COMOOKReceptionConfigurationClass: public ESAT_COMTransceiverConfigurationClass
{
  public:
...
// Instance of the OOK reception configuration class.
extern ESAT_COMOOKReceptionConfigurationClass ESAT_COMOOKReceptionConfiguration;

#endif /* ESAT_COMOOKReceptionConfiguration_h */
