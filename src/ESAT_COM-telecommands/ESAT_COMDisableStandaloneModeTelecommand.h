...
#ifndef ESAT_COMDisableStandaloneModeTelecommand_h
#define ESAT_COMDisableStandaloneModeTelecommand_h

#include <Arduino.h>
#include <ESAT_CCSDSTelecommandPacketHandler.h>
#include <ESAT_SemanticVersionNumber.h>

// Telecommand handler for COM_DISABLE_STANDALONE_MODE.
// Used by ESAT_COM.
class ESAT_COMDisableStandaloneModeTelecommandClass: public ESAT_CCSDSTelecommandPacketHandler
{
  public:
...
// Global instance of ESAT_COMDisableStandaloneModeTelecommandClass.
// Used by ESAT_COMSubsystem.
extern ESAT_COMDisableStandaloneModeTelecommandClass ESAT_COMDisableStandaloneModeTelecommand;

#endif /* ESAT_COMDisableStandaloneModeTelecommand_h */
