...
#ifndef ESAT_COMDisableTelemetryTelecommand_h
#define ESAT_COMDisableTelemetryTelecommand_h

#include <Arduino.h>
#include <ESAT_CCSDSTelecommandPacketHandler.h>
#include <ESAT_SemanticVersionNumber.h>

// Telecommand handler for COM_DISABLE_TELEMETRY.
// Used by ESAT_COMSubsystem.
class ESAT_COMDisableTelemetryTelecommandClass: public ESAT_CCSDSTelecommandPacketHandler
{
  public:
...
// Global instance of ESAT_COMDisableTelemetryTelecommandClass.
// Used by ESAT_COMSubsystem.
extern ESAT_COMDisableTelemetryTelecommandClass ESAT_COMDisableTelemetryTelecommand;

#endif /* ESAT_COMDisableTelemetryTelecommand_h */
