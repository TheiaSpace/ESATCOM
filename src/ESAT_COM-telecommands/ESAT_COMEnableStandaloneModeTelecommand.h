...
#ifndef ESAT_COMEnableStandaloneModeTelecommand_h
#define ESAT_COMEnableStandaloneModeTelecommand_h

#include <Arduino.h>
#include <ESAT_CCSDSTelecommandPacketHandler.h>
#include <ESAT_SemanticVersionNumber.h>

// Telecommand handler for COM_ENABLE_STANDALONE_MODE.
// Used by ESAT_COM.
class ESAT_COMEnableStandaloneModeTelecommandClass: public ESAT_CCSDSTelecommandPacketHandler
{
  public:
...
// Global instance of ESAT_COMEnableStandaloneModeTelecommandClass.
// Used by ESAT_COMSubsystem.
extern ESAT_COMEnableStandaloneModeTelecommandClass ESAT_COMEnableStandaloneModeTelecommand;

#endif /* ESAT_COMEnableStandaloneModeTelecommand_h */
