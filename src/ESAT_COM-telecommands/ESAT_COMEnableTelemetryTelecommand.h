...
#ifndef ESAT_COMEnableTelemetryTelecommand_h
#define ESAT_COMEnableTelemetryTelecommand_h

#include <Arduino.h>
#include <ESAT_CCSDSTelecommandPacketHandler.h>
#include <ESAT_SemanticVersionNumber.h>

// Telecommand handler for COM_ENABLE_TELEMETRY.
// Used by ESAT_COMSubsystem.
class ESAT_COMEnableTelemetryTelecommandClass: public ESAT_CCSDSTelecommandPacketHandler
{
  public:
...
// Global instance of ESAT_COMEnableTelemetryTelecommandClass.
// Used by ESAT_COMSubsystem.
extern ESAT_COMEnableTelemetryTelecommandClass ESAT_COMEnableTelemetryTelecommand;

#endif /* ESAT_COMEnableTelemetryTelecommand_h */
