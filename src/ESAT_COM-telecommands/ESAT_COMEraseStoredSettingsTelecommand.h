...
#ifndef ESAT_COMEraseStoredSettingsTelecommand_h
#define ESAT_COMEraseStoredSettingsTelecommand_h

#include <Arduino.h>
#include <ESAT_CCSDSTelecommandPacketHandler.h>
#include <ESAT_SemanticVersionNumber.h>

// Telecommand handler for COM_ERASE_STORED_SETTINGS.
// Used by ESAT_COM.
class ESAT_COMEraseStoredSettingsTelecommandClass: public ESAT_CCSDSTelecommandPacketHandler
{
  public:
...
// Global instance of ESAT_COMEraseStoredSettingsTelecommandClass.
extern ESAT_COMEraseStoredSettingsTelecommandClass ESAT_COMEraseStoredSettingsTelecommand;

#endif /* ESAT_COMEraseStoredSettingsTelecommand_h */
