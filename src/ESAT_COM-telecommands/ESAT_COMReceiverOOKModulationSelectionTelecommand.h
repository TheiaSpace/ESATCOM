...
#ifndef ESAT_COMReceiverOOKModulationSelectionTelecommand_h
#define ESAT_COMReceiverOOKModulationSelectionTelecommand_h

#include <Arduino.h>
#include <ESAT_CCSDSTelecommandPacketHandler.h>
#include <ESAT_SemanticVersionNumber.h>

// Telecommand handler for COM_RECEIVER_OOK_MODULATION_SELECTION.
// Used by ESAT_COM.
class ESAT_COMReceiverOOKModulationSelectionTelecommandClass: public ESAT_CCSDSTelecommandPacketHandler
{
  public:
...
// Global instance of ESAT_COMReceiverOOKModulationSelectionTelecommandClass.
// Used by ESAT_COM.
extern ESAT_COMReceiverOOKModulationSelectionTelecommandClass ESAT_COMReceiverOOKModulationSelectionTelecommand;

#endif /* ESAT_COMReceiverOOKModulationSelectionTelecommand_h */
