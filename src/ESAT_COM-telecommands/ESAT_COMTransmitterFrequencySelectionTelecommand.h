...
#ifndef ESAT_COMTransmitterFrequencySelectionTelecommand_h
#define ESAT_COMTransmitterFrequencySelectionTelecommand_h

#include <Arduino.h>
#include <ESAT_CCSDSTelecommandPacketHandler.h>
#include <ESAT_SemanticVersionNumber.h>

// Telecommand handler for COM_TRANSMITTER_FREQUENCY_SELECTION.
// Used by ESAT_COM.
class ESAT_COMTransmitterFrequencySelectionTelecommandClass: public ESAT_CCSDSTelecommandPacketHandler
{
  public:
...
// Global instance of ESAT_COMTransmitterFrequencySelectionTelecommandClass.
// Used by ESAT_COM.
extern ESAT_COMTransmitterFrequencySelectionTelecommandClass ESAT_COMTransmitterFrequencySelectionTelecommand;

#endif /* ESAT_COMTransmitterFrequencySelectionTelecommand_h */
